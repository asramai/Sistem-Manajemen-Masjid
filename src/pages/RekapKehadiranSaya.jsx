...
const history = [
  { id: 1, day: 24, month: 'Okt', title: 'Maghrib & Isya', time: '17:45 - 19:30 WIB', status: 'Hadir', icon: 'schedule' },
  { id: 2, day: 24, month: 'Okt', title: 'Subuh', time: '04:15 - 05:00 WIB', status: 'Hadir', icon: 'schedule' },
  { id: 3, day: 23, month: 'Okt', title: 'Maghrib & Isya', time: 'Sakit', status: 'Izin', icon: 'info' },
  { id: 4, day: 22, month: 'Okt', title: 'Jumat', time: '11:30 - 13:00 WIB', status: 'Hadir', icon: 'schedule' },
  { id: 5, day: 20, month: 'Okt', title: 'Subuh', time: 'Tanpa Keterangan', status: 'Alpha', icon: 'error' },
]
      ...
      <div className="col-span-1 md:col-span-4 flex flex-col gap-md">
        ...
        <div className="glass-card rounded-xl p-6 relative overflow-hidden">
          ...
          <div className="flex items-center gap-4 mb-6 relative z-10">
            ...
            <div>
              <h3 className="font-title-md text-title-md text-on-surface">Ahmad Fadillah</h3>
          ...
          <div className="border-t border-outline-variant/30 pt-4 mt-2 relative z-10">
            ...
            <p className="font-headline-lg-mobile text-headline-lg-mobile text-primary font-bold">Rp 50.000</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-md">
          <div className="glass-card rounded-xl p-4 flex flex-col justify-between">
            ...
            <div>
              <p className="font-display-lg text-display-lg text-on-surface leading-tight">24</p>
          ...
          <div className="glass-card rounded-xl p-4 flex flex-col justify-between">
            ...
            <div>
              <p className="font-display-lg text-display-lg text-on-surface leading-tight">2</p>
        ...
        <div className="bg-primary text-on-primary rounded-xl p-6 shadow-md relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-start">
            ...
            <p className="font-display-lg text-display-lg font-bold">Rp 1.200.000</p>
          </div>
        </div>
      </div>
          ...
          <div className="flex-grow overflow-y-auto no-scrollbar pr-2 space-y-3" style={{ maxHeight: '500px' }}>
            {history.map((item) => (
              ...
              >
                ...
                <div className={`px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider ${statusStyles[item.status]}`}>
                  {item.status}
                </div>
              </div>
            ))}
